"""Convert requested thrust and moments into bounded gimbal angles and motor commands."""
...
def roll_headroom(T, params: VehicleParams):
    ...
    tau_p_max_nm note in settings/vehicle.yaml for why the bench headline figure
